...
const (
	...
	// This feature gate controls OCI-HCP specific cluster provisioning logic, resource management, and integration with OCI services for HyperShift-managed clusters.
	// owner: @vkareh
	// alpha: v0.1.50
	// beta: x.y.z
...
var (
	...
	ociHCPFeature                  = featuregates.NewFeature(OCIPlatform, featuregates.WithEnableForFeatureSets(configv1.TechPreviewNoUpgrade))
)
...
func init() {
	...
	allFeatures.AddFeature(ociHCPFeature)
