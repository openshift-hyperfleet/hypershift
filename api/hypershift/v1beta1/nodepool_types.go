...
type NodePoolPlatform struct {
	...
	// +openshift:validation:FeatureGateAwareEnum:featureGate=GCPPlatform,enum=AWS;Azure;GCP;IBMCloud;KubeVirt;Agent;PowerVS;None;OCI;OpenStack
	// +openshift:validation:FeatureGateAwareEnum:featureGate=OCIPlatform,enum=AWS;Azure;GCP;IBMCloud;KubeVirt;Agent;PowerVS;None;OCI;OpenStack
	// +openshift:validation:FeatureGateAwareEnum:featureGate=OpenStack,enum=AWS;Azure;GCP;IBMCloud;KubeVirt;Agent;PowerVS;None;OCI;OpenStack
	// +required
